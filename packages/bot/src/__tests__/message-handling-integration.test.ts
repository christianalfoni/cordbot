...
describe('Message Handling Integration', () => {
  ...
  describe('permission interactions', () => {
    it('should handle permission approval interactions', async () => {
      const mockCore = core as any;
      ...
      // Request permission (this would normally happen during message processing)
      const permissionPromise = core.permissionManager.requestPermission(
        channel,
        'Allow file write?',
        requestId
      );

      // Trigger approval interaction
      ...
      await mockCore.discord.triggerInteraction(approveInteraction);
    ...
    it('should handle permission denial interactions', async () => {
      const mockCore = core as any;
      ...
      await mockCore.discord.triggerInteraction(denyInteraction);
